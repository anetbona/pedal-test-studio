...
> Źródło: https://getdesign.md/apple/design-md (pobrane 2026-06-11, projekt: PedalTest Studio)
...
- Logo: logomark (SVG) centered or left-aligned, 17x48px viewport
...
- Don't center-align body text — body copy is left-aligned; only headlines center
...
- "Build the navigation: sticky, 48px height, background rgba(0,0,0,0.8) with backdrop-filter: saturate(180%) blur(20px). Links at 12px SF Pro Text weight 400, white text. Logo left, links centered, search and bag icons right."
