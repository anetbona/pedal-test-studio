...
const STRINGS = {
  en: {
    ...
    'step2.hint': 'The same riff with different knob settings — click a recording or turn the knobs yourself.',
    'more': 'more',
    'less': 'less',
  ...
  pl: {
    ...
    'step2.hint': 'Ten sam riff w różnych ustawieniach gałek — kliknij nagranie albo pokręć gałkami.',
    'more': 'więcej',
    'less': 'mniej',
